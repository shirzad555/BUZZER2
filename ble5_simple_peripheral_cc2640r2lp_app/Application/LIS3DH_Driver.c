...
//    spiParams.dataSize				   = 16;
    spiHandle = SPI_open(CC2640R2_SABLEXR2_SPI0, &spiParams);
...
//    handle = SPI_open(MOTIONSNS_SPI, &params);
	...
	PINCC26XX_setOutputEnable(Board_SPI0_CSN, 1);
	PINCC26XX_setOutputValue(Board_SPI0_CSN, 1);

	PINCC26XX_setOutputEnable(Board_SPI0_MISO, 0);
...
bool LIS3DH_StartTransfer(uint8_t len, uint8_t * txBuf, uint8_t * rxBuf, uint8_t * args)
{
    ...
    PINCC26XX_setOutputValue(Board_SPI0_CSN, 0);
